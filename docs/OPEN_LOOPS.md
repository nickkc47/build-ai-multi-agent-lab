...
|---|---|---|---|---|---|
| L3 | เติม PROFILE: เหตุผล 1 บรรทัดต่อฮีโร่ใน `## Hero Pool` (ชื่อ 5 ตัวใส่แล้ว) · ยืนยันช่องทางติดต่อนามแฝง (หรือฟอร์มอย่างเดียว) + ลบบรรทัด Contact ที่ว่าง · Bio เวอร์ชันเว็บมุม B ไม่โยงตัวตน (ย่อหน้า 1 ประถม/ร้านเกม/แชมป์โรงเรียน · ย่อหน้า 3 ทำงาน) · Interests ข้อ 1 ตัด "ตั้งแต่ประถม" | human | High | ก่อน Lab 04 | ดู DECISIONS D7 · D8 · D9 |
