...
|---|---|---|---|---|---|
| L11 | Contact: `aria-describedby="status"` ผูกทุกช่องกับกล่องสถานะเดียว → screen reader อ่านข้อความระดับฟอร์มซ้ำทุกช่อง · พิจารณาแยก error รายช่อง | Claude | Low | Lab 06 a11y | `docs/review-pr31.md` ข้อ 3 |
