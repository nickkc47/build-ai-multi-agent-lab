...
- **L3 / L4 (2026-09-25 · เจ้าของตอบ):** "valentine" ใช้บนเว็บเท่านั้น ไม่ซ้ำชื่อในเกม/Discord · repo/git author `nickkc47` ไม่โยงชื่อจริง · Contact = ฟอร์มอย่างเดียว (D7) · Bio เวอร์ชันเว็บมุม B 3 ย่อหน้า — Claude ร่าง เจ้าของอนุมัติ (D9) · Interests ข้อ 1 ตัด "ตั้งแต่ประถม" · เหตุผลรายฮีโร่: **ไม่ใช้** (เจ้าของตัดสิน) — การ์ดแสดง role และหน้าไกด์ D10 ทำหน้าที่ proof แทน (D8)
...
- [x] ~~`## Hero Pool` มีเหตุผล 1 บรรทัดต่อฮีโร่ (D8)~~ — ไม่ใช้ (เจ้าของตัดสิน · ไกด์ D10 แทน · ดู L3 / L4 ด้านบน)
- [x] เจ้าของยืนยันช่องทางติดต่อ: อีเมลที่ใช้นามแฝง หรือ "ฟอร์มอย่างเดียว" · ลบบรรทัด Contact ที่ว่าง/ไม่เปิดเผยออกจาก PROFILE (D7) — ฟอร์มอย่างเดียว
- [x] เจ้าของตอบคำถาม privacy ข้อ 1–2 ใน DEBATE › Devil's Advocate (D9)
- [x] Bio เวอร์ชันเว็บมุม B อยู่ใน PROFILE (D9) — จากนั้น frontend ทำตาม D3–D8 และ `npm test` ต้องเขียว
